...
import (
	"todo/internal/service/handler/auth"
	"todo/internal/service/handler/todo"
	"net/http"
	"strings"
)
...
func (h BaseHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case r.URL.Path == "/dbtasks" && r.Method == "GET":
		{
			tasks.GetAllTasks(w, r)
		}
	case r.URL.Path == "/dbusers" && r.Method == "GET":
		{
			auth.GetAllUsers(w, r)
		}
	default:
		http.NotFound(w, r)
	}
